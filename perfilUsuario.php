...
if(isset($_POST['guardar'])){
    $u = new Usuario($_POST['id'], $_SESSION['user_email_address'], $_POST['password'], $_POST['name'], $_POST['apel1'], $_POST['apel2'], $_POST['birthdate'], $_POST['country'], $_POST['cod_post'], $_POST['phone'], $_POST['rol']);
    UsuarioController::editUser($u);
