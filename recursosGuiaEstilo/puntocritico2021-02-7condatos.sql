...
INSERT INTO `valoracion` VALUES (1,1,1,3.000,'eikepasa'),(2,1,2,3.000,'<p>la <strong>definitiva coññññño</strong></p>'),(3,1,2,4.000,'<p>la polla en verda</p>'),(4,1,2,1.000,'<p>pf yo ke se</p>'),(5,1,1,5.000,'<p>asdfasdf</p>');
