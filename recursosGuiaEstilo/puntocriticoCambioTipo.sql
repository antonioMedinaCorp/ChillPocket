...
INSERT INTO `valoracion` VALUES (1,1,1,3.000,'eikepasa'),(2,1,2,3.000,'<p>la <strong>definitiva coññññño</strong></p>'),(3,1,2,4.000,'<p>la polla en verda</p>'),(4,1,2,1.000,'<p>pf yo ke se</p>'),(5,1,1,2.000,'<p>buenas tardes</p>'),(6,1,2,3.000,'<p>hola que tal prueba del get</p>');
...
-- Dump completed on 2021-02-08 14:49:36
