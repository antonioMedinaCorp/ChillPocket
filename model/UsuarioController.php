...
require_once '../entities/Usuario.php';
    ...
    class UsuarioController{
        ...
        public static function newUser(Usuario $u){
            try {
                $conex = new Conexion();
                $conex->exec("INSERT INTO usuarios  VALUES ('$row->id', '$row->user_name', '$row->password', '$row->name', '$row->apel1', '$row->apel2', '$row->birthdate', '$row->country', '$row->cod_postal', '$row->phone', '$row->rol')");
